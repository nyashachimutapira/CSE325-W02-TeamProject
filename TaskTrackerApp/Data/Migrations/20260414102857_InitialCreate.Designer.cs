...
namespace TaskTrackerApp.Data.Migrations
{
    ...
    [Migration("20260414102857_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskTrackerApp.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("TaskTrackerApp.Data.TaskItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TaskTrackerApp.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TaskTrackerApp.Data.TaskItem", b =>
                {
                    b.HasOne("TaskTrackerApp.Data.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
